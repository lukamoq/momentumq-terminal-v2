...
def compute_bitcoin_halving_cycles(conn: Optional[sqlite3.Connection] = None) -> Dict[str, Any]:
    ...
    cycle_curves = [
        {"day": 0, "cycle1": 1.0, "cycle2": 1.0, "cycle3": 1.0, "cycle4": 1.0, "cycle4_proj": None, "median": 1.0, "phase": "Halving Day 0 (1.0x)"},
        {"day": 50, "cycle1": 1.4, "cycle2": 0.95, "cycle3": 1.15, "cycle4": 1.02, "cycle4_proj": None, "median": 1.08, "phase": "Post-Halving Chop"},
        {"day": 100, "cycle1": 3.2, "cycle2": 1.05, "cycle3": 1.25, "cycle4": 0.98, "cycle4_proj": None, "median": 1.15, "phase": "Miner Capitulation"},
        {"day": 165, "cycle1": 7.5, "cycle2": 1.38, "cycle3": 1.49, "cycle4": 1.05, "cycle4_proj": None, "median": 1.44, "phase": "Breakout Inflection"},
        {"day": 250, "cycle1": 22.0, "cycle2": 2.10, "cycle3": 3.20, "cycle4": 1.08, "cycle4_proj": None, "median": 2.65, "phase": "Parabolic Golden Window"},
        {"day": 371, "cycle1": 93.8, "cycle2": 6.80, "cycle3": 6.50, "cycle4": 1.09, "cycle4_proj": None, "median": 6.65, "phase": "Cycle 1 Peak ($1,150)"},
        {"day": 526, "cycle1": 42.0, "cycle2": 30.3, "cycle3": 7.80, "cycle4": None, "cycle4_proj": None, "median": 19.05, "phase": "Cycle 2 Peak ($19,700)"},
        {"day": 548, "cycle1": 38.0, "cycle2": 26.0, "cycle3": 8.02, "cycle4": None, "cycle4_proj": None, "median": 17.01, "phase": "Cycle 3 Peak ($69,000)"},
        {"day": 680, "cycle1": 22.0, "cycle2": 9.8, "cycle3": 3.60, "cycle4": None, "cycle4_proj": None, "median": 6.70, "phase": "Bear Market Liquidation"},
        {"day": 776, "cycle1": 13.9, "cycle2": 5.8, "cycle3": 2.30, "cycle4": None, "cycle4_proj": None, "median": 4.05, "phase": "Cycle 1 Bottom ($170)"},
        {"day": 853, "cycle1": 15.5, "cycle2": 5.1, "cycle3": 1.95, "cycle4": cur_mult, "cycle4_proj": cur_mult, "median": 3.52, "phase": "Current Spot Position (Day 853)"},
        {"day": 882, "cycle1": 16.2, "cycle2": 4.85, "cycle3": 1.88, "cycle4": None, "cycle4_proj": 1.05, "median": 3.36, "phase": "Cycle 2 Bottom ($3,150)"},
        {"day": 918, "cycle1": 17.0, "cycle2": 5.20, "cycle3": 1.81, "cycle4": None, "cycle4_proj": 1.01, "median": 3.50, "phase": "Cycle 3 Bottom ($15,600)"},
        {"day": 1000, "cycle1": 19.2, "cycle2": 5.85, "cycle3": 2.65, "cycle4": None, "cycle4_proj": 1.25, "median": 4.25, "phase": "Winter Base Accumulation"},
        {"day": 1090, "cycle1": 24.5, "cycle2": 18.2, "cycle3": 3.14, "cycle4": None, "cycle4_proj": 2.80, "median": 10.67, "phase": "When It Rises Again (12 Mo Pre-Halving)"},
        {"day": 1250, "cycle1": 38.0, "cycle2": 12.5, "cycle3": 4.85, "cycle4": None, "cycle4_proj": 4.50, "median": 8.68, "phase": "Pre-Halving Expansion"},
        {"day": 1380, "cycle1": 48.5, "cycle2": 11.2, "cycle3": 8.58, "cycle4": None, "cycle4_proj": 6.20, "median": 9.89, "phase": "Pre-Halving Peak Push"},
        {"day": 1460, "cycle1": 53.06, "cycle2": 13.23, "cycle3": 7.42, "cycle4": None, "cycle4_proj": 7.50, "median": 10.33, "phase": "Next Block Reward Halving (Day 1,460)"},
    ]

    # 8. Full End-to-End Halving-to-Halving Chronological Cycle Flows
    full_cycle_flows = [
        {
            "cycle_id": 1,
            "cycle_title": "Cycle 1 (2012 → 2016 Halving Lifecycle)",
            "timeframe": "Nov 28, 2012 → Jul 9, 2016 (1,319 Days)",
            "start_halving": {"date": "2012-11-28", "price": "$12.25", "block": 210000, "cut": "50 → 25 BTC/block"},
            "chop_phase": {"window": "Days 0 – 79", "dates": "Nov 2012 – Feb 2013", "range": "$12.25 – $27.00", "desc": "Initial miner inventory absorption & early hash re-accumulation"},
            "breakout": {"date": "2013-02-15", "day": 79, "price": "$27.00", "desc": "Decisive volume breakout clearing $27 into parabolic discovery"},
            "macro_peak": {"date": "2013-11-30", "day": 371, "price": "$1,150.00", "gain": "+9,287% (93.8x)", "desc": "Cycle 1 Macro Blow-Off Euphoria Top at $1,150"},
            "bear_trough": {"date": "2015-01-14", "day": 776, "price": "$170.00", "drawdown": "-85.2% (410d post-peak)", "desc": "Mt. Gox collapse liquidation floor at $170"},
            "winter_base": {"window": "Days 776 – 1,037", "dates": "Jan 2015 – Oct 2015", "range": "$200 – $280", "desc": "9-month low-volatility accumulation floor"},
            "rises_again": {"date": "2015-10-01", "day": 1037, "price": "$240.00", "lead": "9 Mo. Pre-H2", "desc": "Secular bull trend ignites, climbing out of winter base"},
            "next_halving": {"date": "2016-07-09", "day": 1319, "price": "$650.00", "gain_from_rise": "+170.8%", "total_cycle_return": "+5,206% ($12.25 → $650)", "desc": "2nd Halving reached at $650 (Block #420,000)"},
            "status": "HISTORICAL_COMPLETE",
        },
        {
            "cycle_id": 2,
            "cycle_title": "Cycle 2 (2016 → 2020 Halving Lifecycle)",
            "timeframe": "Jul 9, 2016 → May 11, 2020 (1,402 Days)",
            "start_halving": {"date": "2016-07-09", "price": "$650.00", "block": 420000, "cut": "25 → 12.5 BTC/block"},
            "chop_phase": {"window": "Days 0 – 167", "dates": "Jul 2016 – Dec 2016", "range": "$590 – $800", "desc": "5.5 months of miner reward cut digestion"},
            "breakout": {"date": "2016-12-23", "day": 167, "price": "$900.00", "desc": "Golden breakout clearing $900 into mainstream ICO mania"},
            "macro_peak": {"date": "2017-12-16", "day": 526, "price": "$19,700.00", "gain": "+2,930% (30.3x)", "desc": "Cycle 2 Retail Mania Top at $19,700 (CME Futures Launch)"},
            "bear_trough": {"date": "2018-12-15", "day": 882, "price": "$3,150.00", "drawdown": "-84.0% (364d post-peak)", "desc": "BCH hash war capitulation bottom at $3,150"},
            "winter_base": {"window": "Days 882 – 1,000", "dates": "Dec 2018 – Apr 2019", "range": "$3,400 – $3,900", "desc": "4-month quiet accumulation base"},
            "rises_again": {"date": "2019-04-02", "day": 1000, "price": "$3,800.00", "lead": "13 Mo. Pre-H3", "desc": "April 2 breakout: explosive candle triggers pre-halving climb"},
            "next_halving": {"date": "2020-05-11", "day": 1402, "price": "$8,600.00", "gain_from_rise": "+126.3%", "total_cycle_return": "+1,223% ($650 → $8,600)", "desc": "3rd Halving reached at $8,600 (after $13.8k summer peak & COVID recovery)"},
            "status": "HISTORICAL_COMPLETE",
        },
        {
            "cycle_id": 3,
            "cycle_title": "Cycle 3 (2020 → 2024 Halving Lifecycle)",
            "timeframe": "May 11, 2020 → Apr 19, 2024 (1,439 Days)",
            "start_halving": {"date": "2020-05-11", "price": "$8,600.00", "block": 630000, "cut": "12.5 → 6.25 BTC/block"},
            "chop_phase": {"window": "Days 0 – 163", "dates": "May 2020 – Oct 2020", "range": "$9,000 – $11,500", "desc": "5.5 months of post-COVID sideways consolidation"},
            "breakout": {"date": "2020-10-21", "day": 163, "price": "$12,800.00", "desc": "PayPal crypto announcement sparks institutional bull run"},
            "macro_peak": {"date": "2021-11-10", "day": 548, "price": "$69,000.00", "gain": "+702% (8.02x)", "desc": "Cycle 3 Double-Top Peak at $69,000 (after $64.8k Spring top)"},
            "bear_trough": {"date": "2022-11-21", "day": 918, "price": "$15,600.00", "drawdown": "-77.4% (376d post-peak)", "desc": "FTX / Luna insolvency contagion floor at $15,600"},
            "winter_base": {"window": "Days 918 – 1,253", "dates": "Nov 2022 – Oct 2023", "range": "$16,500 – $26,000", "desc": "11-month base re-accumulation range"},
            "rises_again": {"date": "2023-10-16", "day": 1253, "price": "$27,000.00", "lead": "6 Mo. Pre-H4", "desc": "BlackRock Spot ETF filing news ignites secular pre-halving rally"},
            "next_halving": {"date": "2024-04-19", "day": 1439, "price": "$63,800.00", "gain_from_rise": "+173.1%", "total_cycle_return": "+641.8% ($8,600 → $63,800)", "desc": "4th Halving reached at $63,800 (after hitting new ATH $73.7k in March 2024)"},
            "status": "HISTORICAL_COMPLETE",
        },
        {
            "cycle_id": 4,
            "cycle_title": "Cycle 4 (2024 → 2028 Active Halving Lifecycle)",
            "timeframe": "Apr 19, 2024 → Apr 17, 2028 (~1,459 Days)",
            "start_halving": {"date": "2024-04-19", "price": "$63,800.00", "block": 840000, "cut": "6.25 → 3.125 BTC/block"},
            "chop_phase": {"window": "Days 0 – 165", "dates": "Apr 2024 – Oct 2024", "range": "$53,000 – $68,000", "desc": "Miner capitulation & ETF supply absorption (Completed)"},
            "breakout": {"date": "2024-10-01", "day": 165, "price": "$64,200.00", "desc": "Q4 breakout into post-halving expansion (Completed)"},
            "macro_peak": {"date": "2025-09-27 → 2025-10-22", "day": 526, "price": "Projected Macro Top", "gain": "Median 526d Cycle Peak", "desc": "Projected Q4 Macro Euphoria Peak Window"},
            "bear_trough": {"date": "2026-08-17 → 2026-10-05", "day": 850, "price": "Projected Cyclical Floor", "drawdown": "Median -80% Drawdown Floor", "desc": "Projected Bear Market Bottom Window (Days 800–900 / Active Window)"},
            "winter_base": {"window": "Days 850 – 1,090", "dates": "Late 2026 – Spring 2027", "range": "On-Chain Realized Price Base", "desc": "Re-accumulation & institutional positioning"},
            "rises_again": {"date": "2027-04-15 (Spring 2027)", "day": 1090, "price": "Secular Ignition Floor", "lead": "12 Mo. Pre-H5", "desc": "Projected next secular bull climb ignition ahead of Halving #5 (~238 Days Remaining)"},
            "next_halving": {"date": "2028-04-17", "day": 1459, "price": "Projected Halving #5 Target", "gain_from_rise": "Projected +150% to +250%", "total_cycle_return": "Projected Multi-Year Expansion", "desc": "5th Halving reached at Block #1,050,000 (Issuance cut to 1.5625 BTC / ~605 Days Remaining)"},
            "status": "ACTIVE_CYCLE",
        },
        {
            "cycle_id": 5,
            "cycle_label": "Cycle 5 (2028 → 2032 Projected Lifecycle)",
            "timeframe": "Apr 17, 2028 → Apr 2032 (~1,460 Days)",
            "start_halving": {"date": "2028-04-17", "price": "Block #1,050,000", "block": 1050000, "cut": "3.125 → 1.5625 BTC/block"},
            "chop_phase": {"window": "Days 0 – 165", "dates": "Apr 2028 – Sep 2028", "range": "Post-H5 Digestion", "desc": "Miner revenue re-adjustment after sub-2 BTC issuance cut"},
            "breakout": {"date": "2028-09-29", "day": 165, "price": "H5 Breakout", "desc": "Post-H5 Breakout into institutional supercycle"},
            "macro_peak": {"date": "2029-09-25", "day": 526, "price": "Cycle 5 Supercycle Peak", "gain": "Projected H5 Peak", "desc": "Projected Cycle 5 Peak Window"},
            "bear_trough": {"date": "2030-08-15", "day": 850, "price": "Cycle 5 Floor", "drawdown": "2030 Cyclical Reset", "desc": "Projected 2030 Bear Bottom Window"},
            "winter_base": {"window": "Days 850 – 1,090", "dates": "2030 – 2031", "range": "Macro Realized Base", "desc": "Sovereign & corporate treasury re-accumulation"},
            "rises_again": {"date": "2031-04-15", "day": 1090, "price": "H6 Ramp Base", "lead": "12 Mo. Pre-H6", "desc": "Pre-halving secular expansion ahead of 2032 Halving #6"},
            "next_halving": {"date": "2032-04-15", "day": 1460, "price": "Block #1,260,000", "gain_from_rise": "Secular Expansion", "total_cycle_return": "Halving #6 Target", "desc": "6th Halving reached (Issuance cut to 0.78125 BTC)"},
            "status": "PROJECTED",
        },
    ]
